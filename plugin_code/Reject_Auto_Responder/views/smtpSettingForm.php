<link href="<?php echo WU_DOMAIN.'/static/styles/plugin/plugin.css'?>" rel="stylesheet" />
<link href="reject.css" rel="stylesheet" />
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo WU_DOMAIN.'/static/scripts/lib/tiny_mce/jquery.tinymce.js'?>"></script>
