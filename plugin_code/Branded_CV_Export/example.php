...
try{
$image = $_REQUEST['img'] ? $_REQUEST['img'] : 'http://anylinuxwork.in/demonew/saurav/tcpdf/examples/images/logo_example.jpg';
$pdf->Image($image, 0, 0, 20, 20, '', 'http://www.tcpdf.org', '', true, 150, '', false, false, 1, false, false, false);
}
catch(Exception $e)
{echo $e;die;}
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
