...
class TCPDF {
	...
	public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false, $pdfa=false) {
		...
		$this->default_form_prop = array('lineWidth'=>0, 'borderStyle'=>'none', 'fillColor'=>array(255, 255, 255), 'strokeColor'=>array(128, 128, 128));
	 ...
	 * @public
	 */
	public function setHeaderData($ln='', $lw=0, $ht='', $hs='', $tc=array(255,255,255), $lc=array(255,255,255)) {
		$this->header_logo = $ln;
