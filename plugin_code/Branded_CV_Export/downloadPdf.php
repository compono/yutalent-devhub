...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->writeHTMLCell(0, 0, 0, 40, '<table border="0"> <tr><th width="100%" align="center">' . $companyName . '</th></tr></table>', 0, 0, false, true, '', true);
        $this->SetFont('helvetica', '', 14, '', true);
        $this->writeHTMLCell(0, 0, 0, 60, '<table border="0"> <tr><th width="100%" align="center" class="candidate-name"> CV: ' . $candidateName . '</th></tr></table>', 0, 0, false, true, '', true);
