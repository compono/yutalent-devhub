...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $writeHTMLCell = $this->writeHTMLCell(0, 0, 10, 10, '<table border="0"> <tr><th width="100%" align="center">
        ...
        $this->writeHTMLCell(0, 0, 60, 0, '<table border="0"> <tr><th width="100%" align="center">' . $companyName . '</th></tr></table>', 0, 0, false, true, '', true);
        $this->SetFont('helvetica', '', 14, '', true);
        $this->writeHTMLCell(0, 0, 80, 0, '<table border="0"> <tr><th width="100%" align="center" class="candidate-name"> CV: ' . $candidateName . '</th></tr></table>', 0, 0, false, true, '', true);
