...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $this->writeHTMLCell(0, 0, 10, 10, '<img height="'.$imageSize['h'].'px" width="'.$imageSize['w'].'px" src="'.$imagePath.'" alt="'.$companyName.'" border="0" />', 0, 1, 'C', 0, '', 1);
        $this->SetTextColorArray(array(120, 129, 132));
        $this->SetFont('helvetica', '',8, '', true);
        $this->writeHTMLCell(0, 0, 0, 30, $companyName, 0, 1, 'C', 0, '', 1);
        $this->SetTextColorArray(array(71, 97, 108));
        $this->SetFont('times', '', 16, '', true);
        $this->writeHTMLCell(0, 0, 0, 33, 'CV: '.$candidateName, 0, 1, 'C', 0, '', 1);
