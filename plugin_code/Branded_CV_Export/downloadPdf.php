...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        $writeHTMLCell = $this->writeHTMLCell(84, 0, 0, 10, '<table border="0"> <tr><th width="100%" align="center">
        ...
        $this->writeHTMLCell(84, 0, 0, 30, '<table border="0"> <tr><th width="100%" align="center">' . $companyName . '</th></tr></table>', 0, 0, false, true, '', true);
        $this->SetTextColorArray(array(71, 97, 108));
        $this->SetFont('times', '', 16, '', true);
        $this->writeHTMLCell(84, 0, 0, 33, '<table> <tr><th width="100%" align="center" class="candidate-name"> CV: ' . $candidateName . '</th></tr></table>', 0, 0, false, true, '', true);
        $style = array('width' => 0.25, 'phase' => 10, 'color' => array(71, 97, 108));
        $this->Line(84, 40, 143.5, 40, $style);
    }
